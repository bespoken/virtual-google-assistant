...
const IntentSchema_1 = require("../src/IntentSchema");
const InteractionModel_1 = require("../src/InteractionModel");
...
describe("UtteranceTest", function () {
    ...
    const is = IntentSchema_1.IntentSchema.fromJSON(intentSchema);
    const model = new InteractionModel_1.InteractionModel(IntentSchema_1.IntentSchema.fromJSON(intentSchema), SampleUtterancesBuilder_1.SampleUtterancesBuilder.fromJSON(sampleUtterances), new virtual_core_1.SlotTypes(slotTypes));
    const japaneseModel = InteractionModel_1.InteractionModel.fromFile("./test/resources/japanese_skill/models/ja-JP.json");
    describe("#matchIntent", () => {
        ...
        describe("Matches for International Languages", function () {
            it("Matches a slotted phrase", () => {
                const utterance = new virtual_core_1.Utterance(japaneseModel, "5 人のプレーヤー");
                chai_1.assert.isTrue(utterance.matched());
            ...
            it("Matches a slotted phrase, no slot value", () => {
                const utterance = new virtual_core_1.Utterance(japaneseModel, "おはよう");
                chai_1.assert.isTrue(utterance.matched());
